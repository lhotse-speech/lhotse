...
def gigaspeech(
    ...
    prepare_gigaspeech(corpus_dir, output_dir=output_dir, num_jobs=num_jobs)
...
def gigaspeech(
    ...
    """Gigaspeech download."""
    download_gigaspeech(target_dir, dataset_parts='librispeech' if full else 'mini_librispeech')
