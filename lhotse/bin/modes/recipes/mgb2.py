...
@click.option(
    "--buck-walter/--no-buck-walter", default=False, help="Use BuckWalter transliteration."
)
...
@click.option(
    "--mer-thresh", default=80, help="filter out segments based on mer (Match Error Rate)."
)
