...
PARTITIONS = {
    "scenario-only": {
        "train": [
            ...
            if meeting not in ["IS1002a", "IS1005d"]
        ],
        "dev": [
            meeting
            for session in ["ES2003", "ES2011", "IS1008", "TS3004", "TS3006"]
            for meeting in MEETINGS[session]
        ],
        "test": [
            meeting
            for session in ["ES2004", "ES2014", "IS1009", "TS3003", "TS3007"]
            for meeting in MEETINGS[session]
        ],
    },
    "full-corpus": {
        ...
        "test": [
            meeting
            for session in ["ES2004", "ES2014", "IS1009", "TS3003", "TS3007", "EN2002"]
            for meeting in MEETINGS[session]
        ],
    },
    "full-corpus-asr": {
        ...
        "test": [
            meeting
            for session in ["ES2004", "IS1009", "TS3003", "EN2002"]
            for meeting in MEETINGS[session]
        ],
    },
}
