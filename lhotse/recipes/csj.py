...
def prepare_csj(
    ...
    :param dataset_parts: string or sequence of strings representing dataset part names, e.g. 'eval1', 'core', 'eval2'. This defaults to the
    ...
    if output_dir:  
        ...
        manifests = read_manifests_if_cached(
            dataset_parts=dataset_parts, output_dir=output_dir, prefix="csj",
        )
    ...
    with ThreadPoolExecutor(num_jobs) as ex:
        for part in tqdm(dataset_parts, desc="Dataset parts"):
            ...
            if output_dir:
                supervision_set.to_file(output_dir / f"csj_supervisions_{part}.jsonl.gz")
