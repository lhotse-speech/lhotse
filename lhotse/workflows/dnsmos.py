...
def download_model(
    ...
    url = (
        "https://github.com/microsoft/DNS-Challenge/blob/master/DNSMOS/pDNSMOS/sig_bak_ovr.onnx"
        if is_personalized_MOS
        else "https://github.com/microsoft/DNS-Challenge/blob/master/DNSMOS/DNSMOS/sig_bak_ovr.onnx"
    )
...
def _annotate_recordings(
    ...
    with ThreadPoolExecutor() as ex:
        ...
        for future in tqdm(futures, desc="Processing"):
            ...
            cut = MonoCut(
                recording=recording, supervisions=[supervision], custom=result
            )
            yield cut
